<template>
  <div
    ...
    class="inline-flex items-center p-0.5 border border-border-2 rounded-pill bg-surface"
  >
    <div class="relative flex items-center">
      <!-- Slider che scivola sotto il bottone attivo -->
      <div
        class="absolute inset-y-0 rounded-pill bg-surface-3 transition-transform duration-250 ease-in-out"
        :style="{
      ...
      <button
        ...
        :class="[
          ...
          modelValue === opt.value ? 'text-gold' : 'text-text-3'
        ]"
      >
        <slot :opt="opt" />
      </button>
